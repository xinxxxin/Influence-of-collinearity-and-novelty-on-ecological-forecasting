...
source("Binomial_response_transpose_function.R")


# Load the results of experiments for normal response
load("Binomial_response_theta_GLM_no_noise_no_RF.RData")

#load("Binomial_response_theta_GLM_no_noise_no_RF_divided_10.RData")
#######################################################################################################################################
#######################################################################################################################################
# Part1: Manipulate raw RMSE/RMSE of control and the results of both GLM and RF
...
# Combine all data
data_analysis_binomial <- rbind(data_high_inter_rrmse, data_high_inter_rrmse_rf, data_high_quad_rrmse,
...
save(data_analysis_binomial, file = "data_analysis_binomial_GLM_RF.RData")
#######################################################################################################################################
...
# Combine all data
data_analysis_binomial_GLM <- rbind(data_high_inter_rrmse, data_high_quad_rrmse, data_high_linear_rrmse,
...
# Export data as a RData file
save(data_analysis_binomial_GLM, file = "data_analysis_binomial_GLM.RData")
#######################################################################################################################################


#######################################################################################################################################
#######################################################################################################################################
# Part3: Manipulate raw RMSE of the results of GLM only
...
data_low_linear_rrmse <- data_transpose(data = low_linear_rrmse, algorithm = "GLM", model = "Linear", 
                                        training_collinearity = "Low", training_correlation = 0.3)
# Combine all data
data_analysis_binomial <- rbind(data_high_inter_rrmse,  data_high_quad_rrmse, data_high_linear_rrmse,
                                data_mid_inter_rrmse, data_mid_quad_rrmse, data_mid_linear_rrmse,
                                data_low_inter_rrmse, data_low_quad_rrmse, data_low_linear_rrmse)
...
# Export data as a RData file
save(data_analysis_binomial, file = "data_analysis_binomial_GLM_no_RF.RData")

#save(data_analysis_binomial, file = "data_analysis_binomial_GLM_no_RF_divided_10.RData")
#######################################################################################################################################
