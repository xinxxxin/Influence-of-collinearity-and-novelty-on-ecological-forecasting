...
source("Normal_response_transpose_function.R")

# Load the results of experiments for normal response
load("Normal_response_theta_GLM_no_noise_no_RF.RData")
...
data_high_inter_rrmse_rf <- data_transpose(data = high_inter_rrmse_rf, algorithm = "RF", model = "Product", 
                                           training_collinearity = "High", training_correlation = 0.9)
...
data_mid_inter_rrmse_rf <- data_transpose(data = mid_inter_rrmse_rf, algorithm = "RF", model = "Product", 
                                          training_collinearity = "Mid", training_correlation = 0.6)
...
data_low_inter_rrmse_rf <- data_transpose(data = low_inter_rrmse_rf, algorithm = "RF", model = "Product", 
                                          training_collinearity = "Low", training_correlation = 0.3)
...
save(data_analysis_normal, file = "data_analysis_normal_GLM_RF_raw_RMSE.RData")
#######################################################################################################################################
...
# Export data as a RData file
save(data_analysis_normal, file = "data_analysis_normal_GLM_RF.RData")
#######################################################################################################################################
...
# Combine all data
data_analysis_normal <- rbind(data_high_inter_rrmse, data_high_quad_rrmse, data_high_linear_rrmse, 
...
# Export data as a RData file
save(data_analysis_normal, file = "data_analysis_normal_GLM_no_RF_raw_RMSE.RData")
#######################################################################################################################################
