...
high_train_coli_interaction <- foreach(icount(100), .combine = 'c') %dopar% {
...
# Save the output
save.image("C:/FSU/Collinearity_extra/Revision/Normal_response/Normal_response_RF.RData")
